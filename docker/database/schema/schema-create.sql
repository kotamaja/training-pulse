...
ALTER TABLE athlete ADD CONSTRAINT FK_C03B8321A76ED395 FOREIGN KEY (user_id) REFERENCES app_user (id) ON DELETE CASCADE;
ALTER TABLE athlete_external_account ADD CONSTRAINT FK_1FC45D0FE6BCB8B FOREIGN KEY (athlete_id) REFERENCES athlete (id) ON DELETE CASCADE;
ALTER TABLE training_activity ADD CONSTRAINT FK_4B111ACDFE6BCB8B FOREIGN KEY (athlete_id) REFERENCES athlete (id) ON DELETE CASCADE;
